...
form Specify files and folders
 ...
 word natFolder 
 word natSound_(with_dot_wav) 
 word natTextgrid_(with_dot_textgrid) 
 natural natTierOfSegment 1
 comment Processee sound
 word nonnatFolder 
 word nonnatSound1_(with_dot_wav) 
 word nonnatTextgrid1_(with_dot_textgrid) 
...
if (natNumIntervals <> nonnatNumIntervals1)
 ...
 newSound0$ = "duration_only-" + nonnatSound1$
 Get resynthesis (PSOLA)
 Rename... nonnatSoundPSOLAObj1
 Write to WAV file... 'outFolder$'/'newSound0$'
 select DurationTier durTier1
